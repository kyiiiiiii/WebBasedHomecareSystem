document.addEventListener('DOMContentLoaded', function() {
    ...
    d3.json("/patient-ages", function(error, data) {
        ...
        var x = d3.scaleLinear()
                  .domain([d3.min(data), d3.max(data)])  // Adjust domain based on the age data
                  .range([0, width]);
        svg.append("g")
        ...
        var y = d3.scaleLinear()
                  .range([height, 0])  // Invert the y-axis by setting the range from height to 0
